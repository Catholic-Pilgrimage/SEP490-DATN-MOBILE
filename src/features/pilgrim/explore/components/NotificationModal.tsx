      ...
      <View style={styles.tabContainer}>
        {(["all", "schedule", "system"] as FilterTab[]).map((tab) => (
          ...
          >
            ...
            >
              {tab === "all"
                ? t("notificationScreen.tabs.all")
                : tab === "schedule"
                  ? t("notificationScreen.tabs.schedule")
                  : t("notificationScreen.tabs.system")}
            </Text>
          </TouchableOpacity>
        ))}
      </View>
              ...
              <View style={styles.emptyContainer}>
                ...
                >
                  <Text style={styles.backButtonText}>
                    {t("notificationScreen.backButton")}
                  </Text>
                </TouchableOpacity>
              </View>
            ) : (
                ...
                ListFooterComponent={
                  loadingMore ? (
                    ...
                    >
                      ...
                      >
                        {t("notificationScreen.loadMoreError")}
                      </Text>
                      <Text
                        style={{
                          color: COLORS.primary,
                      ...
                      >
                        {t("notificationScreen.tapToRetry")}
                      </Text>
                    </TouchableOpacity>
                  ...
                  ) // Increased spacer for better scrolling experience
                }
              />
            )}
          </Animated.View>
