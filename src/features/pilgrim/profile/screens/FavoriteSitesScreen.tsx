      ...
      >
        ...
        >
          <View style={styles.imageContainer}>
            <Image
              source={{
                uri: item.cover_image || "https://via.placeholder.com/300",
              }}
              style={styles.image}
              resizeMode="cover"
            />
          ...
          <View style={styles.cardContent}>
            ...
            <View style={styles.categoryTag}>
              <Text style={styles.categoryText}>
                {item.type === "church"
                  ? t("favoriteSites.types.church")
                  : item.type === "shrine"
                    ? t("favoriteSites.types.shrine")
                    : item.type === "monastery"
                      ? t("favoriteSites.types.monastery")
                      : item.type === "center"
                        ? t("favoriteSites.types.center")
                        : t("favoriteSites.types.other")}
              </Text>
            </View>
          </View>
        </TouchableOpacity>
